...
CREATE SEQUENCE IF NOT EXISTS UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS_PK_SEQ;
CREATE TABLE IF NOT EXISTS UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS (
    UM_ID INTEGER DEFAULT NEXTVAL('UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS_PK_SEQ'),
