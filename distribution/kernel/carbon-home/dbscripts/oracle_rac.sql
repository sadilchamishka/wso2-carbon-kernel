...
CREATE SEQUENCE UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS_SEQ  START WITH 1  INCREMENT BY 1 CACHE 20
/

CREATE OR REPLACE TRIGGER UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS_TRIGGER
        BEFORE INSERT
        ON UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS
        REFERENCING NEW AS NEW
        FOR EACH ROW
            BEGIN
                SELECT UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS_SEQ.nextval INTO :NEW.UM_ID FROM dual;
            END;
/
